...
NODE_LIST=nodeList_32
/home/ajayaku2/gtc/src/lbl/scripts/test/gennodelist.sh > $NODE_LIST

./charmrun +p28 ++mpiexec ++remote-shell "mpiexec -ppn 1" ++nodelist $NODE_LIST  ./superRes small_input/db small_input/inputblocks.txt small_input/outputblocks.txt ++ppn 7
